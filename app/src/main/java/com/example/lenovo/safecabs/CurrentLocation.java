...
public class CurrentLocation extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i1 = getIntent();
        result = i1.getStringExtra("result");
    ...
    private void displayLocation() throws InterruptedException {
        ...
        try {
            ...
            address = ""; // If any additional address line present than only, check with max available address lines by getMaxAddressLineIndex()

            TextView textView2 = (TextView) findViewById(R.id.add);

            int j = 0;
            while ((addresses.get(0).getAddressLine(j)) != null) {
                if ((addresses.get(0).getAddressLine(j + 1)) != null)
